...
const connection = new Sequelize(`${process.env.DIALECT}://${process.env.USERDATABASE}:${process.env.PASSWORD}@${process.env.DATABASEHOST}:${process.env.DATABASEPORT}/${process.env.DATABASE}`);
